...
(function(){
  ...
  const persist4=()=>{localStorage.setItem('dh_transactions',JSON.stringify(state.transactions));localStorage.setItem('dh_students',JSON.stringify(state.students));localStorage.setItem('dh_fees',JSON.stringify(state.fees))};
